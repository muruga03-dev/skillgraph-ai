      ...
      <section style={{ padding: "3.5rem 2rem", background: "linear-gradient(135deg,rgba(61,142,240,.04),rgba(159,122,234,.04))" }}>
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a href="http://localhost:5000/api/auth/google" className="cta-btn" style={{ padding: ".75rem 2rem", borderRadius: 12, background: "#fff", color: "#333", textDecoration: "none", fontSize: ".9rem", fontWeight: 700, display: "inline-flex", alignItems: "center", gap: ".6rem", boxShadow: "0 4px 16px rgba(0,0,0,.3)" }}>
            ...
            <a href="http://localhost:5000/api/auth/linkedin" className="cta-btn" style={{ padding: ".75rem 2rem", borderRadius: 12, background: "#0077B5", color: "#fff", textDecoration: "none", fontSize: ".9rem", fontWeight: 700, display: "inline-flex", alignItems: "center", gap: ".6rem", boxShadow: "0 4px 16px rgba(0,119,181,.4)" }}>
